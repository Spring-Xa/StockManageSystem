...
public class InStock extends JPanel {
	...
	public InStock() {
		...
		panel.setBorder(new TitledBorder(null, "入库操作", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		JLabel lblNewLabel_1 = new JLabel("仓库");
		...
		JButton btnNewButton = new JButton("提交入库");
		panel.add(btnNewButton);

		JButton btnNewButton_3 = new JButton("查询入库");
		panel.add(btnNewButton_3);

		JButton btnNewButton_4 = new JButton("刷新库存");
		panel.add(btnNewButton_4);

		JLabel lblNewLabel_3 = new JLabel("入库编号");
		...
		JButton btnNewButton_2 = new JButton("撤销入库");
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					// 获取仓库
					sql = "SELECT id,namez FROM d_stock";
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "insert into d_instock(bei_pin_id,in_stock_id,in_peo_id,in_time,in_nums) VALUES(?,?,?,now(),?)";
				String account = Login.textField.getText();
				String nums = textField.getText();
				if (nums.equals("")) {
					Tools.showMessage("系统提示", "请输入入库数量");
				} else {
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textField_1.equals("")) {
					Tools.showMessage("系统提示", "请输入入库编号");
				} else {
					String sql = "DELETE FROM d_instock WHERE id=? AND star='0'";
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String sql = "SELECT\r\n" + "	a.id,\r\n" + "	a.bei_pin_id,\r\n" + "	b.namez,\r\n"
						...
						+ "	AND d.account=a.in_peo_id AND d.account=?";
